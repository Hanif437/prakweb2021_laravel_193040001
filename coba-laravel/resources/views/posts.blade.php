    ...
    <div class="container">
        <div class="row">
            @foreach($posts->skip(1) as $post)
                <div class="col-md-4">
                    <div class="card">
                        <div class="posisiton-absolute" style="background-color: (0, 0, 0, 0.7)"><a href="/categories/{{ $post->category->slug }}" class="text-black text-decoration-none">{{ $post->category->name }}</a></div>
